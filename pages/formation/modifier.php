...
?>
    <div class="m-5 a-content">
        <form class=" form p-5 d-flex flex-column w-50" method="post" action="../../traitements/modifier.php?enite=Formation&id=<?=$_GET['id']?>">
            <label for="">Intitule</label>
            <input class="champ" type="text"name="intitule"> <br>
            <label for="">Description</label>
            <input class="champ" type="text"name="description"> <br>
