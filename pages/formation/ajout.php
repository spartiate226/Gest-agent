...
?>
    <div class="m-5 a-content">
        ...
        <form class=" form p-5 d-flex flex-column w-50" method="post" action="../../traitements/ajouter.php?enite=Formation">
            <label for="">Intitule</label>
            <input class="champ" type="text" name="intitule" required> <br>
            <label for="">Description</label>
            <input class="champ" type="text" name="description" required> <br>
